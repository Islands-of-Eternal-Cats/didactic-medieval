...
Tile map resource for a 2D grid of walkable/blocked cells (25×19, 32×32 px), seed-based generation, world↔tile coordinate conversion, WASM `getTileMap()` API, and canvas rendering.
