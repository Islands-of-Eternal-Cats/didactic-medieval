...
**Reason**: Replaced by Tiny Town water tile (index 48) without animated overlay.
**Migration**: Blocked tiles assigned the water type now show a static Tiny Town water tile instead of procedurally animated water.
